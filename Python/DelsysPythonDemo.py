...
def main(with_classifications_indicator=False, debug=False, no_classification=False):
    ...
    controller = LandingScreenController(with_classifications_indicator=with_classifications_indicator,
                                         debug=debug, no_classification=no_classification)
    sys.exit(app.exec())
...
if __name__ == '__main__':
    ...
    parser.set_defaults(with_classifications_indicator=False, debug=False, no_classification=False)
    args = parser.parse_args()
    
    main(with_classifications_indicator=args.with_classifications_indicator, debug=args.debug, no_classification=args.no_classification)